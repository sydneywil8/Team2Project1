<html>
  <body>
    <body style="background-color:LightGray;">
      ...
      <img src="https://github.com/lindseyokeefe/Team2Project1/raw/main/Images/Mexican Catering.jpeg" alt="Image" height="300">
      <h2 style="color:MediumSeaGreen;font-family:verdana;style=font-size:160%">Types of Events We Cater:</h2>
      <ul>
      ...
      <h2 style="color:MediumSeaGreen;font-family:verdana;style=font-size:160%">How We Cater Your Event:</h2>
     <ol>
        ...
        <li><p style="font-family:Times New Roman;font-size:100%;color:black;">Our team delivers and sets up <b><font color="tomato">on site.</font></b></p></li>
      </ol>
      <h2 style="color:MediumSeaGreen;font-family:verdana;style=font-size:160%">Brief History</h2>
